...
exports.SystemStatusDto = void 0;
var swagger_1 = require("@nestjs/swagger");
var SystemStatusDto = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            function SystemStatusDto() {
                ...
                this.message = (__runInitializers(this, _timestamp_extraInitializers), __runInitializers(this, _message_initializers, void 0));
        ...
        (function () {
            ...
            _status_decorators = [(0, swagger_1.ApiProperty)({ example: 'ok', description: 'Status atual da API' })];
            _timestamp_decorators = [(0, swagger_1.ApiProperty)({ example: '2024-02-16T10:00:00Z', description: 'Timestamp da verificação' })];
            _message_decorators = [(0, swagger_1.ApiProperty)({ example: 'API Operacional', description: 'Mensagem de status' })];
