...
var system_status_dto_1 = require("./common/dto/system/system-status.dto");
var AppController = function () {
    ...
    var AppController = _classThis = /** @class */ (function () {
        ...
        AppController_1.prototype.getStatus = function () {
            return {
                status: 'ok',
    ...
    (function () {
        ...
        _getStatus_decorators = [(0, common_1.Get)('status'), (0, swagger_1.ApiOperation)({ summary: 'Verificar status da API' }), (0, swagger_1.ApiResponse)({
                status: 200,
                description: 'API Operacional',
                type: system_status_dto_1.SystemStatusDto,
            })];
